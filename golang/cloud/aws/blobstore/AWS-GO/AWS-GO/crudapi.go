...
func main() {
	aws_access_key_id := "AKIAJFLY5AM7GO7RKILA"                       //please Enter the credentials
	aws_secret_access_key := "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" //please enter the credentials
	token := ""
